...
dtensor_numeric_only_fails = {
    ...
    xfail("eye"),
    xfail("full"),
    # These pass in single-threaded LocalTensorMode but fail in multi-threaded
    # due to non-determinism (eigenvector sign, fill value). They compile fine,
    # so keep them here to exclude from compiled xfails.
    xfail("full_like"),
    xfail("linalg.eigh"),
